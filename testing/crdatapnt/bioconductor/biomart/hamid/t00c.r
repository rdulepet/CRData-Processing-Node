...
setwd("c:\\crdatapnt\\bioconductor")
...
geneList=read.table(file="t00.data",header=T,sep="\t",quote="")
...
vSNPs	<- vData[i,]
detach(vData)
write.csv(vSNPs, file = "vSNPs.csv")
